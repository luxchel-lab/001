...
<div class="ap-tool">
    <div class="wrap">
        ...
        <section class="card" id="visualizer">
            ...
            <p class="section-intro">Краска ложится на снимок комнаты: светотень, тени, затенение в углах и фактура берутся у кадра, а тон и насыщенность — у выбранного цвета. Поэтому на освещённой части стены оказывается ровно тот оттенок, который заколеруют, а вся поверхность выглядит темнее выкраса — как и в жизни.</p>
            ...
            <div class="viz-layout">
                ...
                <div class="viz-controls">
                    ...
                    <div class="field">
                        ...
                        <span class="hint">Кнопка «Купить» открывает карточку краски этого оттенка. Кнопка «Примерить в комнате» в карточке палитры расставляет всю палитру сразу.</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="card" id="calculator">
            ...
            <p class="section-intro">Расчёт по площади, числу слоёв и типу основания. Норма расхода взята для укрывистых интерьерных красок; фактура и пористость поверхности учитываются коэффициентом.</p>
            <p class="section-intro">Цвет выбирается из списка поверхностей примерки — стены, акцентная стена, потолок, столярка, мебель, дверь и пол, — либо любым оттенком из каталога. Каждый цвет считается отдельно: при выборе поверхности площадь подставляется по её геометрии, а объём и фасовка пересчитываются под неё. Так за несколько заходов собирается корзина на всю комнату.</p>
            ...
            <div class="calc-layout">
                <form id="calcForm">
                    ...
                    <div class="field-row" style="margin-top:14px">
                        ...
                        <div class="field" id="calcOpeningsRow">
                    ...
                    <div class="field-row" style="margin-top:14px">
                        <div class="field" style="flex:2 1 320px">
                            <label for="calcProduct">Краска</label>
                            <select id="calcProduct"></select>
                            <span class="hint" id="calcProductNote"></span>
                        </div>
                        <div class="field" style="flex:2 1 300px">
                            <label for="calcColorSel">Цвет</label>
                            <div class="calc-color">
                                <span class="calc-color-sw" id="calcColorSw"></span>
                                <select id="calcColorSel"></select>
                            </div>
                            <span class="hint" id="calcColorNote"></span>
                        </div>
                    </div>
                    <div class="field" style="margin-top:14px">
                        <label style="display:flex;align-items:center;gap:9px;font-weight:600" id="calcCeilingRow">
                            <input id="calcCeiling" type="checkbox" style="width:auto">
                            Красим ещё и потолок в тот же цвет
                        </label>
        ...
        <section class="card" id="cartSection">
            <h2><span class="stepnum">🛒</span>Корзина</h2>
            <p class="section-intro">Здесь собирается всё, что вы добавили: выкрасы, пробники и краска из калькулятора. Количество и объём можно поправить перед оформлением.</p>
            <div id="cartBox"></div>
        </section>

        ...
        <section class="card" id="visualizer">
            ...
            <div class="viz-layout">
                ...
                <div class="viz-controls">
                    ...
                    <div class="field">
                        <label>Свет в комнате</label>
                        <div class="seg seg-lights" id="vizLights"></div>
                        <span class="hint" id="vizLightNote"></span>
                    </div>
                    <div class="field">
                        <label>Поверхности</label>
                        <div class="viz-assign" id="vizAssign"></div>
                        <span class="hint">Клик по квадратику красит поверхность текущим базовым цветом, кнопка «Купить» открывает карточку краски этого оттенка. Кнопка «Примерить в комнате» в карточке палитры расставляет всю палитру сразу.</span>
                    </div>
                </div>
            </div>
        </section>
                ...
                <form id="calcForm">
                    ...
                    <div class="field-row" style="margin-top:14px">
                        ...
                        <div class="field">
                            ...
                            <div class="calc-color" id="calcColor"></div>
                        </div>
                    </div>
